...
const semanticChecks = [
  ...
  ["complex array types", "straddle f(x: [[[int?]]?]) {}"],
  ...
  ["long return", "straddle f()$. .$"],
  ["if statements", "excuses x==0 $. cashout hit .$"],
  [
    "else if",
    "excuses x==0 $. cashout hit .$ noMoreExcuses $. cashout miss .$",
  ],
  ["for over collection", "s"],
