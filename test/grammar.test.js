...
const syntaxChecks = [
  ...
  ["const declaration for strings", "constantPressure stringBet name: "I should be winning more""],
  ["arithmetic sum", "sum :9 + 10"],
  ["arithmetic difference", "difference : 9 - 10"],
  ["arithmetic multiplication", "multiplication : 9 * 10"],
  ["arithmetic division", "division : 9 / 10"],
  ["arithmetic exponents", "exponents : bigspender(9, 10)"],
  ["arithmetic modulus", "modulus : 9 % 10"],
  ["if else function", "excuses x == 0 $. cashout hit .$ followingExcuses (hit) $. cashout miss.$ "],
