// CODE GENERATOR: PokerScript -> JavaScript
//
...
export default function generate(program) {
  ...
  // etc. This is because "switch", for example, is a legal name in PokerScript,
  // but not in JS. So, the PokerScript variable "switch" must become something
  ...
  const generators = {
    ...
    Program(p) {
      output.push("console.log('does not work yet')") // SHOULD BE: gen(p.statements)
    },
    ...
    //   },
    //   TypeDeclaration(d) {
    //     // The only type declaration in PokerScript is the struct! Becomes a JS class.
